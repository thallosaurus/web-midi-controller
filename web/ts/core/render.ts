...
export function render_overlay(overlay: Overlay, render_options: { element?: HTMLDivElement, id?: number, eventbus: EventbusWorkerClient }): LoadedOverlay {
    ...
    for (const ol of overlay.cells) {
        let w = render_widget(ol, children, render_options.eventbus);
        e.append(w.html);
        children.push(w);
    }
...
export function render_widget(cell: Widget, children: Array<LoadedWidget>, eventbus: EventbusWorkerClient, element?: HTMLDivElement): LoadedWidget {
        ...
        case "ccbutton":
            {
                ...
                //CCButton(e, w);
                return new LoadedWidget(cell, e, new CCButtonLifecycle(e, w, eventbus))
            }
        ...
        case "rotary":
            {
                ...
                //Rotary(e, w);
                return new LoadedWidget(cell, e, new RotaryLifecycle(e, w, eventbus))
            }
        ...
        case "ccslider":
            {
                ...
                //CCSlider(e, w);
                return new LoadedWidget(cell, e, new CCSliderLifecycle(e, w, eventbus))
            }
        ...
        case "grid-mixer":
            {
                ...
                return new LoadedWidget(cell, e, new GridMixerNew(e, w, children, eventbus));
            }
        ...
        case "vert-mixer":
            {
                ...
                return new LoadedWidget(cell, e, new VerticalBox(e, w, children, eventbus));
            }
        ...
        case "horiz-mixer":
            {
                ...
                return new LoadedWidget(cell, e, new HorizontalBox(e, w, children, eventbus));
            }
        ...
        case "notebutton":
            {
                ...
                //NoteButton(e, w);
                return new LoadedWidget(cell, e, new NoteButtonLifecycle(e, w, eventbus))
            }

        case "jogwheel":
            {
                const w = cell as JogwheelProperties;
                return new LoadedWidget(cell, e, new JogwheelLifecycle(e, w, eventbus));
                //Jogwheel(e, w);
            }
        ...
        case "xypad":
            {
                ...
                return new LoadedWidget(cell, e, new XYPadLifecycle(e, w, eventbus));
            }

        case "shift":
            {
                const w = cell as ShiftAreaProperties;
                return new LoadedWidget(cell, e, new ShiftArea(e, w, children, eventbus));
            }
    }
